...
BuildRequires:  %{?scl_prefix}python%{python3_pkgversion}-jedi
%endif


%description -n %{?scl_prefix}python%{python3_pkgversion}-%{srcname} %{_description}
...
ln -s ./cython-%{python3_version} %{buildroot}%{_bindir}/cython-3
ln -s ./cython-3 %{buildroot}%{_bindir}/cython
mv %{buildroot}%{_bindir}/cygdb{,-%{python3_version}}
ln -s ./cygdb-%{python3_version} %{buildroot}%{_bindir}/cygdb-3
ln -s ./cygdb-3 %{buildroot}%{_bindir}/cygdb
mv %{buildroot}%{_bindir}/cythonize{,-%{python3_version}}
ln -s ./cythonize-%{python3_version} %{buildroot}%{_bindir}/cythonize-3
ln -s ./cythonize-3 %{buildroot}%{_bindir}/cythonize
...
%changelog
* Tue Feb 04 2020 Lumír Balhar <lbalhar@redhat.com> - 0.29.14-5
...
* Sat Jul 27 2019 Igor Gnatenko <ignatenkobrain@fedoraproject.org> - 0.29.13-1
- Update to 0.29.13
...
* Mon May 13 2019 Igor Gnatenko <ignatenkobrain@fedoraproject.org> - 0.29.7-1
- Update to 0.29.7
